...
public class SJ_ClassModel {
    public void getData(String page,String id,final SJ_ClassModelCallBack callBack){
        ...
        try {
          String  sign = SignUtils.getSignature(map, Api.PRIVATE_KEY);
            ...
            RetrofitUtil.api.postSJClass(page,id,sign,String.valueOf(timestamp))
                    .subscribeOn(Schedulers.io())
                    .observeOn(AndroidSchedulers.mainThread())
                    .subscribe(new Consumer<SJ_classBean>() {
                        @Override
                        public void accept(SJ_classBean bean) throws Exception {
    ...
    public interface SJ_ClassModelCallBack {
